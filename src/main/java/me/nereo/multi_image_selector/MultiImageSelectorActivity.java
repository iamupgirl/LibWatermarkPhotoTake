...
public class MultiImageSelectorActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String locationData = intent.getStringExtra(EXTRA_LOCATION_DATA);
        ...
        if(savedInstanceState == null){
            ...
            bundle.putString(MultiImageSelectorFragment.EXTRA_LOCATION_DATA, locationData);
